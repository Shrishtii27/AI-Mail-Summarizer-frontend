...
function App() {
  ...
  const handleGenerateSummary = async () => {
    ...
    try {
      const response = await axios.post('http://ai-mail-summarizer-backend-ngrriikxt.vercel.app/api/summarize', {
        transcript,
        prompt
      });
  ...
  const handleShareSummary = async () => {
    ...
    setError(null);
    try {
      await axios.post('http://ai-mail-summarizer-backend-ngrriikxt.vercel.app/api/share', {
